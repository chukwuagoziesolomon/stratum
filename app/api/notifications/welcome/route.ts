...
export async function POST(request: Request) {
  try {
      ...
      <div style="font-family: system-ui, sans-serif; color: #0f0b08; background: #f7f8fb; padding: 24px;">
        <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 16px; border: 1px solid #e7e9ed; overflow: hidden; box-shadow: 0 24px 60px rgba(15, 11, 8, 0.08);">
          <div style="background: #0f172a; padding: 24px; color: #ffffff; text-align: center;">
            <h1 style="margin: 0; font-size: 24px; letter-spacing: 0.02em;">Welcome to Stratum Energy Partners</h1>
          </div>
          <div style="padding: 28px 32px;">
            ...
            <p style="margin: 0; font-size: 16px;">Thanks,<br/>The Stratum Team</p>
          </div>
        </div>
      </div>
    `;
    ...
    await sendEmail({
      to: email,
      subject: "Welcome to Stratum Energy Partners",
      html,
      text: `Hi ${name},\n\nWelcome to Stratum Energy Partners. Your account is active and can be funded through the crypto deposit wallet in your dashboard.\n\nOnce your first deposit clears, holdings and performance will display in your account.\n\nThanks,\nThe Stratum Team`,
    });
